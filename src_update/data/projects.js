export const projects = [
  {
    ...
    github: 'https://github.com/Fisheraaa/ETHanomaly', // 暂用，后续替换为正确仓库
    ...
    detailEn: {
      background: "This is my core project. The starting point was simple: I didn't want to just watch signal alerts — I wanted to know whether a trading judgment actually holds up historically. The goal is to evolve an information tool into a full trading system with backtesting and risk control.",
      highlights: [
  ...
  },
  {
    ...
    shortDescEn: 'Natural language input, LLM-powered profile extraction, force-directed relationship graph and bubble chart visualization.',
    detailZh: {
