      ...
      <div className="page-inner--narrow">
        ...
        <div className="contact-list">
            ...
            <div className="contact-btn-icon">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839
                  ...
                  1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0
                  0022 12.017C22 6.484 17.522 2 12 2z"/>
              </svg>
            </div>
            <div className="contact-btn-body">
          ...
          <p className="contact-star-hint">
            {isZh
              ? '觉得作者 / 网站还不错的可以去 GitHub 点个 star 支持下喔 ⭐'
              : 'If you like what you see, a star on GitHub would mean a lot ⭐'}
          </p>
        </div>
      </div>
    </motion.section>
