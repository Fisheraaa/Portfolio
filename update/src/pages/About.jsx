...
const SKILLS_ZH = [
  ...
  { label: '编程', items: ['Python（熟练）', 'C, Java, JS 基础', 'SQL / Pandas 数据处理'] },
...
const SKILLS_EN = [
  ...
  { label: 'Programming', items: ['Python (proficient)', 'C, Java, JS basics', 'SQL / Pandas data processing'] },
